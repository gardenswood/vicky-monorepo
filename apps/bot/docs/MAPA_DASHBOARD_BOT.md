...
| `/clientes` | `clientes`, `consultasLena` | CRM, filtros, export, alta rápida leña | Actualizar CRM con marcadores; detectar oportunidades |
| `/clientes/[tel]` | `clientes`, `consultasLena` | Editar ficha y registrar consulta | Usar datos de zona, dirección, intereses, estado comercial |
...
- Si hay interés de leña no confirmado, usar `consultasLena`.
- Si el pedido de leña está confirmado, usar el flujo de `colaLena`.
